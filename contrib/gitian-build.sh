...
DEFAULT_BHP_SIGS=${BHP_SIGS:-'bhp.sigs'}
DEFAULT_GITIAN_REPO='https://github.com/devrandom/gitian-builder'
DEFAULT_GBUILD_FLAGS=''
DEFAULT_SIGS_REPO='https://github.com/bhpnet/bhp.sigs'
...
The signature will be saved in '${DEFAULT_BHP_SIGS}/'. An alternative output directory
for signatures can be supplied via the environment variable \$BHP_SIGS.
...
f_build() {
  ...
  bin/gbuild --commit bhp="$g_commit" ${GBUILD_FLAGS} "$l_descriptor"
...
g_sigs_dir=${BHP_SIGS:-"${g_workdir}/${DEFAULT_BHP_SIGS}"}
