...
func (msg MsgTokenIssue) ValidateBasic() sdk.Error {
	...
	// check totalSupply
	totalSupply, b := sdk.NewIntFromString(msg.TotalSupply)
	if b != true {
		return sdk.ErrInvalidCoins("")
	}
	//totalSupply.GT(sdk.NewInt(TotalSupplyUpperbound)) ||  Bhp41
	if totalSupply.LTE(sdk.NewInt(0)) {
...
func NewMsgTokenBurn(amount sdk.Coin, owner sdk.AccAddress) MsgTokenBurn {
	return MsgTokenBurn{
		Amount: amount,
		Owner:  owner,
	}
...
func NewMsgTokenMint(amount sdk.Coin, owner sdk.AccAddress) MsgTokenMint {
	return MsgTokenMint{
		Amount: amount,
		Owner:  owner,
	}
...
func (msg MsgTokenMint) ValidateBasic() sdk.Error {
	...
	if amount.GT(sdk.NewIntFromBigInt(big.NewInt(TotalSupplyUpperbound))) {
