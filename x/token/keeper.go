...
//Bhp6
func (k Keeper) SendCoinsFromAccountToAccount(ctx sdk.Context, from, to sdk.AccAddress, amt sdk.Coins) error {
	return k.bankKeeper.SendCoins(ctx, from, to, amt)
}

// nolint
//Bhp7
func (k Keeper) LockCoins(ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins, lockCoinsType int) error {
...
//Bhp8
// nolint
func (k Keeper) updateLockedCoins(ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins, doAdd bool, lockCoinsType int) error {
	var key []byte
...
//Bhp10
// nolint
func (k Keeper) UnlockCoins(ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins, lockCoinsType int) error {
	// update lock coins
...
func (k Keeper) GetLockedCoins(ctx sdk.Context, addr sdk.AccAddress) (coins sdk.Coins) {
	store := ctx.KVStore(k.lockStoreKey)
...
func (k Keeper) IterateLockedFees(ctx sdk.Context, cb func(acc sdk.AccAddress, coins sdk.Coins) (stop bool)) {
	store := ctx.KVStore(k.lockStoreKey)
...
func (k Keeper) BalanceAccount(ctx sdk.Context, addr sdk.AccAddress, outputCoins sdk.Coins,
	inputCoins sdk.Coins) (err error) {
