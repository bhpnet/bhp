...
const DefaultTokenOwner = "bhp1v5gsqsc2q0334c53ceuuj9z0akssgh8h6d47fv"
...
func ExportGenesis(ctx sdk.Context, keeper Keeper) (data GenesisState) {
	...
	//BHp33
	keeper.IterateLockedFees(ctx, func(acc sdk.AccAddress, coins sdk.Coins) bool {
...
func IssueOKT(ctx sdk.Context, k Keeper, genesisState json.RawMessage, acc auth.Account) error {
	...
	for _, t := range data.Tokens {
		...
		if !strings.Contains(coins.String(), t.Symbol) {
			coins = append(coins, sdk.NewCoin(t.Symbol, t.TotalSupply))
			sort.Sort(coins)
