...
func getCmdTokenIssue(cdc *codec.Codec) *cobra.Command {
	...
	cmd.Flags().StringP(Symbol, "k", "", "symbol of the new token")
...
func getCmdTransferOwnership(cdc *codec.Codec) *cobra.Command {
	...
	cmd.Flags().StringP("symbol", "k", "", "symbol of the token to be transferred")
...
func getCmdTokenEdit(cdc *codec.Codec) *cobra.Command {
	...
	cmd.Flags().StringP(Symbol, "k", "", "symbol of the token")
