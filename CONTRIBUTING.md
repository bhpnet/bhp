...
Thank you for considering making contributions to BHP and related
repositories!
...
1. Either [open](https://github.com/bhpnet/bhp/issues/new/choose) or
   [find](https://github.com/bhpnet/bhp/issues) an issue you'd like to help with
...
3. If you would like to contribute:
   ...
   4. Follow standard Github best practices: fork the repo, branch from the
      ...
      - For core developers working within the bhp repo, to ensure a clear
...
Take a peek at our [coding repo](https://github.com/bhpnet/coding) for
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/bhpnet/bhp/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
If you open a PR on the BHP, it is mandatory to update the relevant documentation in https://github.com/bhpnet/docs.

## Forking

Please note that Go requires code to live under absolute paths, which complicates forking.
While my fork lives at `https://github.com/<username>/bhp`,
the code should never exist at `$GOPATH/src/github.com/<username>/bhp`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/bhpnet/bhp`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on github, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/bhpnet/bhp`)
- `git remote rename origin upstream`
- `git remote add origin git@github.com:<username>/bhp.git`

Now `origin` refers to my fork and `upstream` refers to the BHP version.
So I can `git push -u origin master` to update my fork, and make pull requests to BHP from there.
...
- create a development branch either on github.com/bhpnet/bhp, or your fork (using `git remote add origin`)
