...
func TestBhpCLIKeysAddMultisig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start bhpd server with minimum fees
...
func TestBhpCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.MakeCodec()
	...
	genFile := filepath.Join(f.BhpdHome, "config", "genesis.json")
...
func TestBhpCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestBhpCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.BhpcliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestBhpdCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestBhpdAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
