...
type (
	...
	AppExporter func(*server.Context, log.Logger, dbm.DB, io.Writer, int64, bool) (int64, json.RawMessage, []tmtypes.GenesisValidator, error)

	// AppReset is a function that reset all app state to particular height
	AppReset func(*server.Context, log.Logger, dbm.DB, io.Writer, int64) error
)
